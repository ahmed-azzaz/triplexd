...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "name.stmt": "TriplexD stands for <em>Data-Driven Decisions</em> — three D's, one belief.",
      "name.body": "It's the whole company in a name. Every system we build exists to turn raw operational data into decisions a leader can stand behind — data goes in, gets driven through trustworthy KPIs, and a confident decision comes out. The full stop in our wordmark is deliberate: it reads as a decision made, a statement closed.",
      "name.pron": "DDD &nbsp;·&nbsp; Data-Driven Decisions",
    ...
    ar: {
      ...
      "name.eyebrow": "الاسم",
      "name.stmt": "يعني اسم TriplexD <em>قرارات مبنية على البيانات</em> — ثلاثة أحرف D، وقناعة واحدة.",
      "name.body": "إنه ملخّص الشركة كلّها في اسم. كل نظام نبنيه موجود لتحويل البيانات التشغيلية الخام إلى قرارات يقف خلفها القائد بثقة — بيانات تدخل، وتُقاد عبر مؤشرات جديرة بالثقة، فيخرج قرار واثق. والنقطة في شعارنا مقصودة: تُقرأ كقرارٍ اتُّخذ، وجملةٍ اكتملت.",
      "name.pron": "DDD &nbsp;·&nbsp; قرارات مبنية على البيانات",
